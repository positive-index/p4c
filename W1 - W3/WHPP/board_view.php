...
<?php
	...
	if ($is_count) {
		mq("UPDATE board SET `hit` = `hit` + 1 where num = ".$bno);
    ...
    <ul id="board_list">
        <?php
            ...
            while( $row = mysqli_fetch_array($sql3) ){
            	echo "<li>";
            	echo "<div><span class='col1'>".$row['name']."</span></div>";
            	echo "<span class='col2'>".$row['content']."</span>";
            	echo "<span class='col3'>".$row['date']."</span>";
            	echo "</li>";
            }
		?>
	</ul>
